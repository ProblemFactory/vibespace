...
const _s = (d, opts = {}) => {
  ...
  return `<svg aria-hidden="true" focusable="false" style="width:1em;height:1em;vertical-align:-0.125em" viewBox="0 0 16 16" fill="${fill}" stroke="${stroke}" stroke-width="${sw}" stroke-linecap="round" stroke-linejoin="round">${d}</svg>`;
};
...
export const UI_ICONS = {
  image:     FILE_ICONS.image, // image media cards (chat-renderers) share the file-type glyph
  alert: `<svg aria-hidden="true" focusable="false" viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="8" cy="8" r="6.2"/><path d="M8 4.8v3.6" stroke-linecap="round"/><circle cx="8" cy="11" r="0.9" fill="currentColor" stroke="none"/></svg>`,
  // Tool cards
  ...
  // A For-you inbox reply (design-user-inbox-reply, 2026-09-23): the arrow
  ...
  send:      _s('<path d="M2.5 8l11-5-4 10.5-2-4.5z"/><path d="M7.5 9l6-6"/>'),
