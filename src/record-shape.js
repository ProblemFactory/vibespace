...
const SHAPES = {
  ...
  "claude:stream:system/turn_handoff_available": sh(['v', 'tools', 'worker_epoch', 'relay_marker']),
  ...
  "claude:stream:system/permission_denied": sh(['tool_name', 'tool_use_id', 'agent_id', 'decision_reason_type', 'decision_reason', 'message']),
