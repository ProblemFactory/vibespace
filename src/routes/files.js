...
router.get('/api/home', async (req, res) => {
  ...
  res.json({ home: os.homedir(), authEnabled: !!req.app.locals.authEnabled, ssoEnabled: !!req.app.locals.ssoEnabled, repoDir: path.resolve(__dirname, '..', '..'), publicUrlDefault: process.env.VIBESPACE_PUBLIC_URL || null });
});
