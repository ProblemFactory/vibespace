...
import { installTelemetry, track, metric, reportBootTime, installLongTaskWatch, recentLongTasks, gpuRenderer, installCompositorStallWatch, installScreenWatch, recentCompositorStalls } from './lib/telemetry-client.js';
...
installScreenWatch(); // DPR changes + screen moves (the owner's two freeze triggers), into the ring the freeze capture carries
