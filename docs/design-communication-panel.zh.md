...
### P0 — store、索引所有者、adapter 接口、假 adapter、panel 骨架、**集成层** — **17–19 轮 (8.5–9.5 天)**
...
**总计:** P0–P4 = **57–68 轮 ≈ 28.5–34 个工作日**(按每天 2 轮), 外加那两次 scope 往返的
