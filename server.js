...
const {
  ...
  probeUsageViaSession, recordCodexQuotaSignal, recordRateLimitEvent, resolveUsageKey,
...
const { setupSessionPty, attachToDtach, readSessionMeta, writeSessionMeta,
  ...
  engine: { _vsuPending, armWorkflowUsageWatcher, kickPoolEval, markLimitBanner,
    ...
    modelsMatch, recordCodexQuotaSignal, recordRateLimitEvent, resolveUsageKey, usageEstimator },
