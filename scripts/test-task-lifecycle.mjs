...
ok('a scriptPath launch ack → the Summary line is the name (never the bare "workflow" placeholder)', p2b && p2b.id === 'wf_f1347581-5e6' && p2b.description.startsWith('inc-mubu23bd-5vxi: the CLI rate_limit_event type') && p2b.description.length <= 120 && p2b.description !== 'workflow', JSON.stringify(p2b));
